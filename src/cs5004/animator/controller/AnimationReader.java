...
public class AnimationReader {
  ...
  /**
   * Reads the canvas of the passed scanner.
   *
   * @param s       scanner object.
   * @param builder the build main object.
   * @param <Doc>   the object type.
   */
  ...
  /**
   * Reads the shape arguments.
   *
   * @param s       the scanner object.
   * @param builder the builder main object.
   * @param <Doc>   the object type.
   */
  ...
  /**
   * Reads any motion/animation in the scanner.
   *
   * @param s       the scanner object.
   * @param builder the builder main object.
   * @param <Doc>   the type.
  ...
  /**
   * Checks if the argument is an integer and returns it formatted.
   *
   * @param s         the scanner object.
   * @param label     the label in case an error occurs.
   * @param fieldName the fieldName, again, for troubleshooting.
